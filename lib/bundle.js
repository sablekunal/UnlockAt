/**
 * Unified binary bundle format for .unlockat files.
 ...
 * [Remaining] ENCRYPTED_DATA (includes auth tag at end)
 */

const MAGIC = Buffer.from('UNLOCKAT');
const VERSION = 1;

export function createBundle(encryptedDataWithTag, fragmentA, iv, metadata = {}) {
    ...
    return Buffer.concat([
        ...
        metadataLenBuf,             // 4
        metadataBuf,                // N
        encryptedDataWithTag        // Remaining (Data + Tag)
    ]);
}
